...
public class Experiment5 {
    ...
    public Experiment5(String paraIndexDir,
                       String pageIndexDir,
                       String mainDir,
                       String outputDir,
                       String dataDir,
    ...
    private void makeRunStrings(String queryId,
        ...
        for (int i = 0; i < scoreDocs.length; i++) {
            ...
            runFileString = query + " Q0 " + pID + " " + (i + 1) + " " + topDocs.scoreDocs[i].score + " " + "QERelEnt";
    ...
    public static void main(@NotNull String[] args) {
        ...
        new Experiment5(paraIndexDir, pageIndexDir, mainDir, outputDir, dataDir, idFile, entityRunFile,
                outFile, entityQrel, takeKEntities, omit, analyzer, similarity);
