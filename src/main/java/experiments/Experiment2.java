...
/**
 * Purpose: This class does the second new experiment for ECIR 2019 paper.
...
public class Experiment2 {
    ...
    public Experiment2(String supportPassageRunFile,
        ...
        Scanner sc = null;
        try {
            sc = new Scanner(new File(supportPassageRunFile));
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        assert sc != null;
        METHOD = sc.nextLine().split(" ")[5];
    ...
    private void makeRunFileStrings(@NotNull Map<String, Map<String, Double>> newRunFileMap,
        ...
        for (String queryID : newRunFileMap.keySet()) {
            ...
            for (String paraID : sortedMap.keySet()) {
                ...
                runString = queryID + " Q0 " + paraID + " " + rank++ + " " + score + " " + METHOD + "-passage";
    ...
    public static void main(@NotNull String[] args) {
        ...
        new Experiment2(supportPassageRunFile, candidatePassageRunFile, newPassageRunFile);
    }
}
