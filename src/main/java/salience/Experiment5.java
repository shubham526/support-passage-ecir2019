...
public class Experiment5 {
     ...
     */
    public Experiment5(String entityFile, String passageFile, String swatFile, String entityQrelFile, String indexDir, String outDir) {
                ...
                for (Document document : documentList) {
                    ...
                    if (salientEntityMap.containsKey(paraID)) {
                        ...
                        if ( ! (saliencyMap == null) ) {
                            ...
                            if (saliencyMap.containsKey(entityId)) {
    ...
    public static void main(@NotNull String[] args) {
        ...
        new Experiment5(entityFile, passageFile, swatFile, entityQrelFile, indexDir, outDir);
    }
}
